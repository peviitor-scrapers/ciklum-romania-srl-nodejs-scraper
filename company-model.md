...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/ciklum-romania-srl-nodejs-scraper/master/.github/workflows/job-seeker-ro-spider.yml`)
