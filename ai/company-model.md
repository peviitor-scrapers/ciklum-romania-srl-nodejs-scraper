...
| group        | string   | Parent company group (e.g. "Ciklum Systems") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/peviitor-scrapers/ciklum-romania-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)