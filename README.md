[![Oportunitati SI Cariere](https://github.com/peviitor-scrapers/ciklum-romania-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml/badge.svg)](https://github.com/peviitor-scrapers/ciklum-romania-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml)
[![Automation Tests](https://github.com/peviitor-scrapers/ciklum-romania-srl-nodejs-scraper/actions/workflows/automation-testing.yml/badge.svg)](https://github.com/peviitor-scrapers/ciklum-romania-srl-nodejs-scraper/actions/workflows/automation-testing.yml)
[![Version](https://img.shields.io/github/package-json/v/peviitor-scrapers/ciklum-romania-srl-nodejs-scraper?label=version&color=blue)](CHANGELOG.md)
[![Test Results](https://img.shields.io/badge/test--results-HTML-9b59b6)](https://peviitor-scrapers.github.io/ciklum-romania-srl-nodejs-scraper/test-results/)
...
[![GitHub Pages](https://img.shields.io/github/deployments/peviitor-scrapers/ciklum-romania-srl-nodejs-scraper/github-pages?label=GitHub%20Pages)](https://peviitor-scrapers.github.io/ciklum-romania-srl-nodejs-scraper/)

# job_seeker_ro_spider — Ciklum Careers Romania Scraper

**job_seeker_ro_spider** — un scraper pentru job-urile Ciklum din România. Extrage anunțurile de pe [explore-jobs.ciklum.com](https://explore-jobs.ciklum.com) (Oracle HCM SPA renderat cu headless Chromium) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul Peviitor.
...
- Extrage job-uri de pe site-ul Ciklum Careers (Oracle HCM SPA renderat cu headless Chromium, filtrat pe România)
